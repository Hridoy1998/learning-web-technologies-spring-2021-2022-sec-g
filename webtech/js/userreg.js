function regvab(){
  ...
  function regvas(){
    ...
    let xhttp2 = new XMLHttpRequest();
              ...
              xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
              xhttp2.send('submitNewseller='+submit+' & first_name='+first_name+'& last_name='+last_name+' & username='+username+' & dob='+dob+' & gender='+gender+' & email='+email+' & phonenumber='+phonenumber+' & password='+password+' & src='+profilepic);
