...
<body>
    ...
    <form method="POST" action="" enctype="multipart/form-data" align="center">
        ...
        <table border="1" colspan="3" align="center">
			...
			$con = getConnection();
			$sql = "SELECT * FROM user where type='Seller' and id='{$noticeEdit}'";
        ...
        <br>
        <input type="button" id="EDIT" value="EDIT" name="EDIT" onclick="return editSprofiletag(<?php echo $noticeEdit;?>)">
			<input type="button" id="BLOCK" value="BLOCK" name="BLOCK" onclick="return Vblockseller(<?php echo $noticeEdit;?>)">
            <br> <br><br>
