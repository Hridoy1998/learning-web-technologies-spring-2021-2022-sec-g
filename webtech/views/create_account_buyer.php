...
<body>
        ...
        <form action="../controllers/regchek_for_buyer.php" method="POST" enctype="multipart/form-data" align="center">
            ...
            <input type="button" name="submitNewbuyer" value="SUBMIT"id="submit" onclick="return regvab()"><br><br>
